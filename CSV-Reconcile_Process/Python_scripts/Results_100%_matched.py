...
df1 = pd.read_csv("/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/Examples/FDH/Reconciled/pref_label_matched.csv")
df1['Type'] = str('skos:prefLabel')
df1['NALT_URI'] = df1['Nalt_URI']
df3 = df1.drop(['Nalt_URI'], axis=1)

df2 = pd.read_csv("/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/Examples/FDH/Reconciled/alt_label_matched.csv")
