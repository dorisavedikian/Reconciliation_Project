...
#df2['Nalt_URI'] = df2['Nalt_URI_suffix'].str[:-7]  
df2['Nalt_URI'] = df2['Nalt_URI_suffix'].str.split('_*').str[0]          
...
print('Please note, the Nalt_URI column is empty in this dataframe because there exists a nalt term that differs slightly from the SME proposed label in this list (ie, a case difference, an additional comma, etc.')