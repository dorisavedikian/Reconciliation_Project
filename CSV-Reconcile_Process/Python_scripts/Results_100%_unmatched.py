...
df1 = pd.read_csv("/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/Examples/Cotton/Reconciled/pref_label_unmatched.csv")                                          
df2 = pd.read_csv("/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/Examples/Cotton/Reconciled/alt_label_unmatched.csv")   
df3 = pd.concat([df1, df2])
df4 = df3.drop(df3.iloc[:,3:11], axis=1)    
df5 = df4.loc[df4['Score'] == 100] 
df6 = df5.drop_duplicates(keep='first')
df6.to_excel('/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/examples/Cotton/reconciled/unmatched_but_100.xlsx', sheet_name='Manually Look-up', index=False) 
...
os.remove("/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/Examples/Cotton/Reconciled/pref_label_unmatched.csv")
os.remove("/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/Examples/Cotton/Reconciled/alt_label_unmatched.csv")
