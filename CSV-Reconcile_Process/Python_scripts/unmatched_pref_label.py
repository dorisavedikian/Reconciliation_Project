...
df = pd.read_csv('/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/Examples/AWIC/Reconciled/unmatched_pref_label.csv')
df1 = df.drop(df.iloc[:,3:12], axis=1)
df2 = df1.loc[df1['Score'] == 100] 
df3 = df1.loc[df1['Score'] < 100]
df4 = df3.drop(['Score'], axis=1) 

df2.to_csv("/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/Examples/AWIC/Reconciled/pref_label_unmatched.csv", index=False)
...
os.remove('/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/Examples/AWIC/Reconciled/unmatched_pref_label.csv')
