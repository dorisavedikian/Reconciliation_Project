...
df1 = pd.read_csv("/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/shorter_process/Examples/ADC/Reconciled/pref_label_matched.csv")
df1['Type'] = str('skos:prefLabel')
df1['NALT_URI_Best_Match'] = df1['Nalt_URI_Best_Match']
df3 = df1.drop(['Nalt_URI_Best_Match'], axis=1)

df2 = pd.read_csv("/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/shorter_process/Examples/ADC/Reconciled/alt_label_matched.csv")
...
df5.to_excel("/Volumes/USDA HD/NAL/MyGitFolder/Reconciliation_Project/CSV-Reconcile_Process/shorter_process/examples/ADC/reconciled/matched_reconciliation.xlsx", sheet_name='Perfect Matches', index = False)
...
# python3 shorter_process/python_scripts/Perfect_matches.py
